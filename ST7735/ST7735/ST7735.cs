...
/// <summary>
/// Adapted from GHI Electronics driver https://github.com/ghi-electronics/FEZ-Shields 
/// </summary>
namespace MicroToolskit.Hardware.Displays.TFTColor
{
    /// <summary>
    ...
    /// <summary>
    /// Draws shapes, images and text on a graphical display controlled by ST7735
    /// </summary>
    public class ST7735
    {
        private SPI spi;
        ...
        /// <summary>
        /// The width of the display in pixels (160px).
        /// </summary>
        public const int Width = 160;

        /// <summary>
        /// The height of the display in pixels (128px).
        /// </summary>
        public const int Height = 128;

        /// <summary>
        /// Built a display on SPI Bus. (Arduino connector) 
        /// </summary>
        /// <param name="CtrlPin : TFT_DC (D8)"></param>
        /// <param name="ChipSelect : TFT_CS (D10)"></param>
        /// <param name="SpiBus : SCK (D13), MOSI (D11), "></param>
        public ST7735(Cpu.Pin CtrlPin, Cpu.Pin ChipSelect, SPI.SPI_module SpiBus)
        {
            buffer1 = new byte[1];
            buffer2 = new byte[2];
            buffer4 = new byte[4];
            ...
            controlPin = new OutputPort(CtrlPin, false);

            SPI.Configuration MyConfig =
             new SPI.Configuration(ChipSelect,
             false, 0, 0, false, true, 4000, SpiBus);
